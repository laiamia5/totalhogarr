            ...
            <div class="container pb-5">
                <div class="row">
                    <div class="col-lg-5 mt-5">
                        <div class="card mb-3" style={{maxHeight: '450px', overflow: 'hidden'}}>
                            <img style={{objectFit: 'contain'}} class="card-img img-fluid" src={prod.img} alt="Card image cap" id="product-detail"/>
                        </div>
                        <div class="row">
                            {/* <!--Start Controls--> */}
                    ...
                    <div class="col-lg-7 mt-5">
                        <div class="card">
                            <div class="card-body">
                                <h1 class="h2">{prod.nombre}</h1>
                                <p class="h3 py-2">$ {prod.precio}</p>
                                <p class="py-2">
                                ...
                                <ul class="list-inline">
                                    ...
                                    <li class="list-inline-item">
                                        <p class="text-muted"><strong>{prod.marca}</strong></p>
                                    </li>
                                </ul>
                                ...
                                <ul class="list-inline">
                                    ...
                                    <li class="list-inline-item">
                                        <p class="text-muted"><strong>{prod.stock}</strong></p>
                                    </li>
                                </ul>
                                ...
                                <ul class="list-inline">
                                    ...
                                    <li class="list-inline-item">
                                        <p class="text-muted"><strong>{prod.categoria}</strong></p>
                                    </li>
                                </ul>
